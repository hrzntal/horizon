/datum/species
	var/list/screamsounds = list('hrzn/modules/emotes/sound/voice/scream_m1.ogg', 'hrzn/modules/emotes/sound/voice/scream_m2.ogg')
...
/datum/species/lizard
	screamsounds = list('hrzn/modules/emotes/sound/voice/scream_lizard.ogg')

/datum/species/skeleton
	screamsounds = list('hrzn/modules/emotes/sound/voice/scream_skeleton.ogg')

/datum/species/fly
	screamsounds = list('hrzn/modules/emotes/sound/voice/scream_moth.ogg')
