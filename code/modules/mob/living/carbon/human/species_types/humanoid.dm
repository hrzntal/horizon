/datum/species/humanoid
	name = "Humanoid"
	id = "humanoid"
	flavor_text = "A term used for most sentient bipedal creatures, but most often used to classify those more human-like in nature. Genemodders, or humans with body mods, are often labeled as such."
	default_color = "444"
