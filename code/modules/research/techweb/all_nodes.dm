...
/datum/techweb_node/micro_bluespace
	...
	design_ids = list("bluespace_matter_bin", "femto_mani", "bluespacebodybag", "triphasic_scanning", "wormholeprojector")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 10000)
...
/datum/techweb_node/emp_basic //EMP tech for some reason
	...
	prereq_ids = list("base")
	design_ids = list("holosign", "holosignsec", "holosignengi", "holosignatmos", "holosignrestaurant", "holosignbar", "inducer", "tray_goggles", "holopad", "vendatray")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/basic_mining
	...
	design_ids = list("drill", "superresonator", "triggermod", "damagemod", "cooldownmod", "rangemod", "ore_redemption", "mining_equipment_vendor", "cargoexpress", "plasmacutter", "mining_drill", "mining_brace", "metal_density_scanner")//e a r l y    g a  m e)
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/adv_mining
	...
	design_ids = list("drill_diamond", "jackhammer", "hypermod", "plasmacutter_adv", "adv_metal_density_scanner")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 7500)
