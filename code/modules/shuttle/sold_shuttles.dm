...
/datum/sold_shuttle/vulture
	...
	detailed_desc = "It's medium sized and is equipped with 3 propulsion engine, canisters of co2 and oxygen, a portable generator, two mining lasers, a transporter and some emergency supplies. It has quarters and a restroom"
